<template>
  <div v-if="jobs">
    ...
    <pre>
    Backup X last backup ... FAILS (xxxx-xx-xx  / 1 hour ago), next scheduled at xxxxxxxx
    Repository Y last check : OK  (xxxx-xx-xx / 2 hours ago), next scheduled at xxxxxx
    Repository Z last check : unknown, next scheduled at xxxxxx
    </pre>
